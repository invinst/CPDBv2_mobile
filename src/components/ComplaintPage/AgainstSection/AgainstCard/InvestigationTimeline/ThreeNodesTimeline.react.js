...
const ThreeNodesTimeline = React.createClass({
  propTypes: {
  ...
  render() {
    ...
    const firstLineStyle = allegationPresenter.incidentDate ? dashLine : noStyle;
    const secondLineStyle = presenter.isOpenInvestigation ? dashLine : noStyle;
...
export default ThreeNodesTimeline;
