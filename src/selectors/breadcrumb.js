...
import { BREADCRUMB_DEFAULT_MAPPING } from 'constants';
...
const getBreadcrumbMapping = state => {
  const breadcrumbsMapping = get(state, 'breadcrumb.breadcrumbMapping', {});
  return { ...breadcrumbsMapping, ...BREADCRUMB_DEFAULT_MAPPING };
};
