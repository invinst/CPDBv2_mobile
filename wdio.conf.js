...
const initCommands = require('./integration-test-wdio/custom-commands');
...
exports.config = {
  ...
  onPrepare: function (config, capabilities) {
    webpackServer = new WebpackDevServer(webpack(webpackConfig), webpackConfig.devServer);
    webpackServer.listen(webpackConfig.devServer.port, 'localhost', (err) => {
      if (err) {
        console.error(err);
      }
      console.info('Listening at localhost:' + webpackConfig.devServer.port);
  ...
  beforeTest: function (test) {
    browser.setWindowRect(0, 0, 375, 667);
  },
  //
