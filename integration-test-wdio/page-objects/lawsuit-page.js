...
class PaymentSection extends Section {
  constructor() {
    ...
    this.prepareElementGetters({
      ...
      subtotalsLegalFees: '(//*[contains(@class, "subtotals")] //*[contains(@class, "highlight-value")])[2]',
      totalsRowValue: '//*[contains(@class, "total-payments")] //*[contains(@class, "row-value")]',
    });
  }
}
...
class LawsuitPage extends Page {
  ...
  constructor() {
    ...
    this.prepareElementGetters({
      ...
      totalPaymentSummary: '.total-payments-summary',
